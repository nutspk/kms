  ...
  <div class="row" >
      ...
      <div class="col-10 col-md-7 " >
          <article class="textTab4">
              <div>
                <h1 class="textNews2">Java-EP 2 :โครงสร้างของภาษา Java </h1>
                  <img src="https://s3-ap-southeast-1.amazonaws.com/makeweb/axZuSidgl/DefaultData/java_programming_ternary_operation.jpg" class="imgNews4" >
              </div>
             
              
              
              
              <p class="fontP">ในบทนี้ คุณจะได้เรียนโครงสร้างพื้นฐานของภาษา Java และรูปแบบต่างๆ 
                ในการใช้งานของภาษา เราจะมาเริ่มต้นกับโปรแกรมสุดคลาสสิค Hello World Program
                Hello word program
                Hello World Program เป็นโปรแกรมแรกที่โปรแกรมเมอร์ทุกคนจะได้เขียน มันเป็นโปรแกรมที่แสดงข้อความว่า 
                "Hello World!" ออกทางหน้าจอคอมพิวเตอร์ของคุณ ถ้าคุณสร้างโปรเจ็คของคุณแล้ว ตอนนี้คัดลอกโปรแกรมข้างล่างไปรันได้เลย</p>
              
                <img src="https://cdn.filestackcontent.com/MY55ailTTKuCLndxLHoW" class="imgNews4" >
...
<!--Start-body-right-->   
      <div class=" col-8 col-md-5 ">
          <article class="textTabcard">
            ...
            <div class="textTab5">
              <br>
            <h1 class="fontHeadLinkNews2" style="margin-top: 12%; margin-bottom: -3%;"> Software Engineer</h1>
            <div class="container ">
              <!--NewS1-->
