...
{{-- <link href="css/detailtravel.css" rel="stylesheet"> --}}

<script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.4.0/css/font-awesome.min.css"></script>
<title>Document</title>

<link href="{{asset('css/bootstrap.min.css')}}" rel="stylesheet">
<link href="{{asset('https://getbootstrap.com/docs/4.0/layout/grid/')}}" rel="stylesheet">
<link href="{{asset('https://fonts.googleapis.com/css?family=Kodchasan&display=swap')}}" rel="stylesheet">
<link href="{{asset('https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css')}}" rel="stylesheet">
...
<link href="{{asset('css/detailtravel.css')}}" rel="stylesheet">
</head>