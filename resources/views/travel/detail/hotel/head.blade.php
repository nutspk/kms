...
{{-- <link href="css/detailhotel.css" rel="stylesheet"> --}}
...
<link href="{{asset('css/bootstrap.min.css')}}" rel="stylesheet">
  ...
  <link href="{{asset('https://getbootstrap.com/docs/4.0/layout/grid/')}}" rel="canonical">
  ...
  <link href="{{asset('css/detailhotel.css')}}" rel="stylesheet">
